...
//Hydration levels for humans. The other guy had no idea so I follow his error
#define HYDRATION_LEVEL_SLAKED 550
#define HYDRATION_LEVEL_HYDRATED 450
#define HYDRATION_LEVEL_DEHYDRATED 250
#define HYDRATION_LEVEL_DANGEROUSLYDEHYDRATED 150