...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(2) //security
			return list(access_morgue, access_sec_doors, access_weapons, access_security, access_brig, access_armory, access_forensics_lockers, access_court, access_hos, access_engine)
		if(3) //medbay
